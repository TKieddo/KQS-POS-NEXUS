-- Safe Fresh Customer and Credit System Setup
-- Run this script in your Supabase SQL Editor

-- Step 1: Disable triggers temporarily to avoid conflicts
DO $$
BEGIN
    -- Disable all triggers on customers table
    ALTER TABLE customers DISABLE TRIGGER ALL;
    ALTER TABLE credit_accounts DISABLE TRIGGER ALL;
EXCEPTION
...
-- Step 4: Create fresh customers table
...
-- Step 5: Create fresh credit_accounts table
...
-- Step 6: Create credit_transactions table for tracking
...
-- Step 10: Insert sample customers for testing
...
-- Success message
SELECT 'Fresh customer and credit system setup completed successfully!' as status;
