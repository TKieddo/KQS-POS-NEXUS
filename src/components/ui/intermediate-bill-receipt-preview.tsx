...
interface IntermediateBillReceiptPreviewProps {
  className?: string
}

const IntermediateBillReceiptPreview: React.FC<IntermediateBillReceiptPreviewProps> = ({ className }) => {
  // Sample data for intermediate bill
  const sampleData = {
    business_name: 'KQS',
    business_address: 'Maseru, Husteds opposite Queen II',
    business_phone: '2700 7795',
    business_website: 'kqs-boutique.com',
    bill_number: 'KQS-BILL-2024-000321',
    date: '21-Dec-24',
    time: '13:05 PM',
    cashier_name: 'Hape',
  ...
  return (
    <PremiumCard className={`p-6 ${className}`}>
      <div className="text-center mb-6">
        <h3 className="text-xl font-semibold text-gray-900 mb-2">KQS Intermediate Bill</h3>
        <p className="text-sm text-gray-600">Non-final bill for review before payment</p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-4 max-w-sm mx-auto font-mono text-xs shadow-lg relative">
        ...
        <div className="mb-3 space-y-1">
          <div className="text-gray-700">Bill #: {sampleData.bill_number}</div>
...
export default IntermediateBillReceiptPreview 