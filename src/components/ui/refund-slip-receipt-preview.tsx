...
interface RefundSlipReceiptPreviewProps {
  className?: string
}

const RefundSlipReceiptPreview: React.FC<RefundSlipReceiptPreviewProps> = ({ className }) => {
  // Sample data for refund slip
  const sampleData = {
    business_name: 'KQS',
    business_address: 'Maseru, Husteds opposite Queen II',
    business_phone: '2700 7795',
    business_website: 'kqs-boutique.com',
    refund_number: 'KQS-RF-2024-00088',
    date: '24-Dec-24',
    time: '15:45 PM',
    cashier_name: 'Hape',
    ...
    refund_amount: 2050.00,
    reason: 'Product defect and wrong size'
  }
  ...
  return (
    <PremiumCard className={`p-6 ${className}`}>
      <div className="text-center mb-6">
        <h3 className="text-xl font-semibold text-gray-900 mb-2">KQS Refund Slip</h3>
        <p className="text-sm text-gray-600">Slip for refunded items and amount</p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-4 max-w-sm mx-auto font-mono text-xs shadow-lg relative">
        ...
        <div className="mb-3 space-y-1">
          <div className="text-gray-700">Refund #: {sampleData.refund_number}</div>
        ...
        <div className="mb-3 space-y-1">
          <div className="flex justify-between text-gray-900 font-bold border-t pt-1">
            ...
            <span>{formatCurrency(sampleData.refund_amount)}</span>
          </div>
        </div>
        ...
        {/* Refund Policy */}
        <div className="mb-3">
          <div className="text-center font-bold text-gray-900 mb-1">Refund Policy</div>
          <div className="text-gray-700 text-xs leading-tight bg-gray-50 p-2 rounded-sm">
            Refunds are processed for valid reasons only and require original receipt.<br />
            <span className="italic text-gray-600">
              Chelete e khutlisetsoa feela haeba ho na le lebaka le utloahalang le invoice ea pele.
            </span>
          </div>
        </div>
...
export default RefundSlipReceiptPreview 