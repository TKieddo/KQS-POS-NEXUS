...
import { ArrowLeft, Search, Edit, Receipt, AlertCircle, CheckCircle, XCircle, Calendar, Clock, Filter, DollarSign } from 'lucide-react'
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="today" className="mt-0">
              <div className="mb-6">
                ...
                <p className="text-gray-600">Sales from today that can be edited</p>
              </div>
              {todaySales.length === 0 ? (
                renderEmptyState(
                  "No today's sales found",
                  searchQuery ? "Try adjusting your search terms" : "No sales from today available for editing"
                )
              ) : (
            ...
            <TabsContent value="other" className="mt-0">
              <div className="mb-6">
                ...
                <p className="text-gray-600">Sales from previous days that can be edited</p>
              </div>
              {otherSales.length === 0 ? (
                renderEmptyState(
                  "No other sales found",
                  searchQuery ? "Try adjusting your search terms" : "No other sales available for editing"
                )
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
