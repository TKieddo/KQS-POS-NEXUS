-- Update Refund Function to Handle Customer Balance Correctly
-- This updates the process_complete_refund function to use customers.account_balance
    ...
    BEGIN
        ...
        IF p_refund_method = 'account' AND v_customer_id IS NOT NULL THEN
            ...
            INSERT INTO credit_transactions (
                ...
                COALESCE(v_current_balance, 0) + p_refund_amount,
                v_refund_id,
                'refund',
                NOW()
            );
