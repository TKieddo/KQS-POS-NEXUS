-- Final Cashflow Fix
-- This script fixes the bigint vs integer type mismatch for days_with_entries

-- Drop and recreate the function with proper type casting for all columns
...
BEGIN
    ...
    SELECT 
        ...
        CAST(COUNT(DISTINCT ds.summary_date) AS INTEGER) as days_with_entries
