-- Fresh Customer Management Schema (Fixed)
...
-- ========================================
-- INDEXES FOR PERFORMANCE (Updated to match existing)
-- ========================================
...
-- ========================================
-- TRIGGERS FOR AUTOMATIC UPDATES (Updated to match existing)
-- ========================================
...
CREATE TRIGGER update_loyalty_accounts_updated_at BEFORE UPDATE ON public.loyalty_accounts FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- Simple policies that allow authenticated users to access all data
