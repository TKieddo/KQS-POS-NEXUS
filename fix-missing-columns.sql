-- =====================================================
-- Fix Missing Columns
-- Run this to add any missing columns to the tables
-- =====================================================

-- First, let's drop and recreate the user_activity_logs table to ensure proper structure
DROP TABLE IF EXISTS user_activity_logs CASCADE;

-- Recreate user_activity_logs table with proper structure
...
-- Ensure security_settings table has proper structure
DROP TABLE IF EXISTS security_settings CASCADE;

-- Recreate security_settings table with proper structure
...
-- Ensure users table has all required auth columns
ALTER TABLE users 
