-- KQS POS Fresh Database Migration
...
DROP TABLE IF EXISTS laybye_items CASCADE;
DROP TABLE IF EXISTS refund_items CASCADE;
DROP TABLE IF EXISTS stock_movements CASCADE;
DROP TABLE IF EXISTS category_variant_configs CASCADE;
DROP TABLE IF EXISTS variant_options CASCADE;
DROP TABLE IF EXISTS variant_option_types CASCADE;
DROP TABLE IF EXISTS laybye_payments CASCADE;
DROP TABLE IF EXISTS laybye_orders CASCADE;
...
SELECT 'KQS POS Database migration completed successfully!' as status; 